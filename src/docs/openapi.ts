...
const testimonialSchema = {
  ...
  properties: {
    id: { type: "string", format: "uuid" },
    authorName: { type: "string", example: "Juliana R.", description: "Pode ser vazio." },
    text: { type: "string" },
    rating: { type: "integer", minimum: 1, maximum: 5 },
    sortOrder: { type: "integer" },
    isVisible: { type: "boolean" },
    layout: { type: "string", enum: ["stack", "quote"], nullable: true },
    padding: { type: "string", enum: ["sm", "md", "lg"], nullable: true },
    spacing: { type: "string", enum: ["sm", "md", "lg"], nullable: true },
  },
};
    ...
    "/me/profile/blocks": {
      ...
      post: {
        ...
        description: [
          ...
          "- `TESTIMONIALS`: { heading, layout: stack|quote, itemStyles? } (os itens vem de /me/profile/testimonials)",
      ...
      post: {
        ...
        requestBody: body({
          ...
          properties: {
            ...
            sortOrder: { type: "integer" },
            isVisible: { type: "boolean" },
            layout: { type: "string", enum: ["stack", "quote"] },
